...
struct User {
    ...
    static var currentUser = User(userName: "Pushpinder", email: "psuhpi@gmail.com", age: 20)
    
    static func logIn (user2 : User){
        currentUser = user2
        print("\(user2.userName) is logged in")
    }
}
...
var u = User(userName: "Rajat", email: "rajat@gmail.com", age: 20)
User.logIn(user2: u)
print(User.currentUser)
