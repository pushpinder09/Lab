...
struct User
{
    ...
    var height : Double
    var weight : Double
    var activtyLevel : Int
}

//:  Create a variable instance of `User` and call it your name. Use the memberwise initializer to pass in information about yourself. Then print out a description of your `User` instance using the instance's properties.
var pushpinder = User(name: "Pushpinder Thakur", age: 20, height: 67, weight: 62.0, activtyLevel: 9)
print("User name  \(pushpinder.name) of age \(pushpinder.age) and height \(pushpinder.height) and weight \(pushpinder.weight) is at activity level \(pushpinder.activtyLevel)")
/*:
