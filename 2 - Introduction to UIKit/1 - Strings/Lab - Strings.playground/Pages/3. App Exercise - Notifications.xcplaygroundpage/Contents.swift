...
let newBest = 15125
print("Congratualtions \(fullName) ! You beat your previous daily high score of  \(previousBest) steps by walking \(newBest) STEPS YESTERDAY ")
/*:
