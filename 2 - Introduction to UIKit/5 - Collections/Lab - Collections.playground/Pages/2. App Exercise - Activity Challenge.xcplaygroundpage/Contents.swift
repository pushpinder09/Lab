 ...
 */
var walking = ["Walk 3 miles a day  "," Walk atleast 2 miles "]
var running = ["In 18 seconds complete the track of 100M" ,"Run 8 miles"]
...
var challeneges = [walking,running]
print(challeneges[1][0])

//:  All of the challenges will reset at the end of the month. Use the `removeAll` to remove everything from `challenges`. Print `challenges`.
challeneges.removeAll()
print(challeneges)
