 ...
 */
  ...
  progressUpdate(steps: 34, goal: 90)
  progressUpdate(steps: 78, goal: 100)
  progressUpdate(steps: 89, goal:1000)
...
pacing(currentDistance: 40, totalDistance: 100, currentTime: 4, goalTime: 2)
